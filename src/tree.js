...
module.exports = {
  TreeUtil,
  TreeConfig,
  TreeView: function (root, container, options) {
    var self = this;
    ...
    function renderNode(node) {
      ...
      if (node.isLeaf()) {
        ...
        if (icon != "") {
          ...
          (icon = TreeUtil.getProperty(options, "leaf_icon", "")) != ""
        ) {
          ret += '<span class="tj_icon">' + icon + "</span>";
        } else {
        ...
        if (icon != "") {
          ...
          (icon = TreeUtil.getProperty(options, "parent_icon", "")) != ""
        ) {
          ret += '<span class="tj_icon">' + icon + "</span>";
        } else {
  ...
  TreeNode: function (userObject, options) {
